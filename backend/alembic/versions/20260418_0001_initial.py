...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.UniqueConstraint("project_id", "question_key", name="uq_questionnaire_answers_key"),
    )
    op.create_index("ix_questionnaire_answers_project_id", "questionnaire_answers", ["project_id"])
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.UniqueConstraint("project_id", "file_path", name="uq_generated_files_path"),
    )
...
def downgrade() -> None:
    ...
    op.drop_index("ix_questionnaire_answers_project_id", table_name="questionnaire_answers")
